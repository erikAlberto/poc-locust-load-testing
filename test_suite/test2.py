...
class OnboardingWallet(TaskSet):
    ...
    def on_start(self):
        ...
        if len(USER_CREDENTIALS) > 0:
            self.phone_number_data, self.imei_data, self.document_number_data, self.document_city_data, self.date_of_birth_data, self.email_data, self.pin = USER_CREDENTIALS.pop()
